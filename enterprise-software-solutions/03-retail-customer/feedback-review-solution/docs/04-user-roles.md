# 04 - Feedback Roles & Permissions

| Role | Access Level | Primary Responsibilities |
| :--- | :--- | :--- |
| **Marketing Director** | Master Access | Reporting, aggregate sentiment analysis, widget configuration. |
| **Reputation Manager** | Elevated Access | Responding to complex reviews, dispute resolution, moderation. |
